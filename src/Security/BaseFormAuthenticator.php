...
abstract class BaseFormAuthenticator extends AbstractFormLoginAuthenticator
{
    use TargetPathTrait;
     ...
     * @return BaseFormAuthenticator
     */
    protected function setLoginRoute(string $loginRoute): BaseFormAuthenticator
    {
     ...
     * @return BaseFormAuthenticator
     */
    protected function setHomeRoute(string $homeRoute): BaseFormAuthenticator
    {
