 ...
 * SomdaTdr3
 *
 * @ORM\Table(name="somda_tdr_3", indexes={@ORM\Index(name="idx_48536_tijd", columns={"tijd"}), @ORM\Index(name="idx_48536_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48536_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr3
{
