...
/**
 * SomdaTdr11Treinnummerlijst
 *
 * @ORM\Table(name="somda_tdr_11_treinnummerlijst", indexes={@ORM\Index(name="idx_48381_nr_start", columns={"nr_start"}), @ORM\Index(name="idx_48381_nr_eind", columns={"nr_eind"})})
 * @ORM\Entity
 */
class SomdaTdr11Treinnummerlijst
{
    /**
     * @var int
     *
