 ...
 * SomdaTdr8In
 *
 * @ORM\Table(name="somda_tdr_8_in", uniqueConstraints={@ORM\UniqueConstraint(name="idx_48907_treinnr", columns={"treinnr", "rijdagenid", "locatie", "tijd"})}, indexes={@ORM\Index(name="idx_48907_tijd", columns={"tijd"}), @ORM\Index(name="idx_48907_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48907_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr8In
{
