...
/**
 * SomdaTdr10Treinnummerlijst
 *
 * @ORM\Table(name="somda_tdr_10_treinnummerlijst", indexes={@ORM\Index(name="idx_48381_nr_start", columns={"nr_start"}), @ORM\Index(name="idx_48381_nr_eind", columns={"nr_eind"})})
 * @ORM\Entity
 */
class SomdaTdr10Treinnummerlijst
{
    /**
     * @var int
     *
