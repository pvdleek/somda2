...
/**
 * SomdaTdr7Treinnummerlijst
 *
 * @ORM\Table(name="somda_tdr_7_treinnummerlijst", indexes={@ORM\Index(name="idx_48874_nr_start", columns={"nr_start"}), @ORM\Index(name="idx_48874_nr_eind", columns={"nr_eind"})})
 * @ORM\Entity
 */
class SomdaTdr7Treinnummerlijst
{
    /**
     * @var int
     *
