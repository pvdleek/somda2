...
/**
 * SomdaTdr8Treinnummerlijst
 *
 * @ORM\Table(name="somda_tdr_8_treinnummerlijst", indexes={@ORM\Index(name="idx_48946_nr_start", columns={"nr_start"}), @ORM\Index(name="idx_48946_nr_eind", columns={"nr_eind"})})
 * @ORM\Entity
 */
class SomdaTdr8Treinnummerlijst
{
    /**
     * @var int
     *
