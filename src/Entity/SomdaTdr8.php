 ...
 * SomdaTdr8
 *
 * @ORM\Table(name="somda_tdr_8", indexes={@ORM\Index(name="idx_48896_tijd", columns={"tijd"}), @ORM\Index(name="idx_48896_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48896_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr8
{
