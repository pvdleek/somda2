...
/**
 * SomdaTdr6Treinnummerlijst
 *
 * @ORM\Table(name="somda_tdr_6_treinnummerlijst", indexes={@ORM\Index(name="idx_48802_nr_start", columns={"nr_start"}), @ORM\Index(name="idx_48802_nr_eind", columns={"nr_eind"})})
 * @ORM\Entity
 */
class SomdaTdr6Treinnummerlijst
{
    /**
     * @var int
     *
