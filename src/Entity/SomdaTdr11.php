 ...
 * SomdaTdr11
 *
 * @ORM\Table(name="somda_tdr_11", indexes={@ORM\Index(name="idx_48331_tijd", columns={"tijd"}), @ORM\Index(name="idx_48331_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48331_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr11
{
