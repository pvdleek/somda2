...
/**
 * SomdaTdr9Treinnummerlijst
 *
 * @ORM\Table(name="somda_tdr_9_treinnummerlijst", indexes={@ORM\Index(name="idx_49018_nr_start", columns={"nr_start"}), @ORM\Index(name="idx_49018_nr_eind", columns={"nr_eind"})})
 * @ORM\Entity
 */
class SomdaTdr9Treinnummerlijst
{
    /**
     * @var int
     *
