 ...
 * SomdaTdr1In
 *
 * @ORM\Table(name="somda_tdr_1_in", uniqueConstraints={@ORM\UniqueConstraint(name="idx_48403_treinnr", columns={"treinnr", "rijdagenid", "locatie", "tijd"})}, indexes={@ORM\Index(name="idx_48403_tijd", columns={"tijd"}), @ORM\Index(name="idx_48403_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48403_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr1In
{
