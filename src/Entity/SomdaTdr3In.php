 ...
 * SomdaTdr3In
 *
 * @ORM\Table(name="somda_tdr_3_in", uniqueConstraints={@ORM\UniqueConstraint(name="idx_48547_treinnr", columns={"treinnr", "rijdagenid", "locatie", "tijd"})}, indexes={@ORM\Index(name="idx_48547_tijd", columns={"tijd"}), @ORM\Index(name="idx_48547_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48547_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr3In
{
