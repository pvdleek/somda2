...
/**
 * SomdaTdr2Treinnummerlijst
 *
 * @ORM\Table(name="somda_tdr_2_treinnummerlijst", indexes={@ORM\Index(name="idx_48514_nr_start", columns={"nr_start"}), @ORM\Index(name="idx_48514_nr_eind", columns={"nr_eind"})})
 * @ORM\Entity
 */
class SomdaTdr2Treinnummerlijst
{
    /**
     * @var int
     *
