 ...
 * SomdaTdr5In
 *
 * @ORM\Table(name="somda_tdr_5_in", uniqueConstraints={@ORM\UniqueConstraint(name="idx_48691_treinnr", columns={"treinnr", "rijdagenid", "locatie", "tijd"})}, indexes={@ORM\Index(name="idx_48691_tijd", columns={"tijd"}), @ORM\Index(name="idx_48691_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48691_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr5In
{
