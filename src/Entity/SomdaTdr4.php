 ...
 * SomdaTdr4
 *
 * @ORM\Table(name="somda_tdr_4", indexes={@ORM\Index(name="idx_48608_tijd", columns={"tijd"}), @ORM\Index(name="idx_48608_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48608_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr4
{
