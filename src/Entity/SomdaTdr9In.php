 ...
 * SomdaTdr9In
 *
 * @ORM\Table(name="somda_tdr_9_in", uniqueConstraints={@ORM\UniqueConstraint(name="idx_48979_treinnr", columns={"treinnr", "rijdagenid", "locatie", "tijd"})}, indexes={@ORM\Index(name="idx_48979_tijd", columns={"tijd"}), @ORM\Index(name="idx_48979_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48979_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr9In
{
