...
/**
 * SomdaTdr5Treinnummerlijst
 *
 * @ORM\Table(name="somda_tdr_5_treinnummerlijst", indexes={@ORM\Index(name="idx_48730_nr_start", columns={"nr_start"}), @ORM\Index(name="idx_48730_nr_eind", columns={"nr_eind"})})
 * @ORM\Entity
 */
class SomdaTdr5Treinnummerlijst
{
    /**
     * @var int
     *
