...
/**
 * SomdaTdr4Treinnummerlijst
 *
 * @ORM\Table(name="somda_tdr_4_treinnummerlijst", indexes={@ORM\Index(name="idx_48658_nr_start", columns={"nr_start"}), @ORM\Index(name="idx_48658_nr_eind", columns={"nr_eind"})})
 * @ORM\Entity
 */
class SomdaTdr4Treinnummerlijst
{
    /**
     * @var int
     *
