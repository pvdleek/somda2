 ...
 * SomdaTdr7In
 *
 * @ORM\Table(name="somda_tdr_7_in", uniqueConstraints={@ORM\UniqueConstraint(name="idx_48835_treinnr", columns={"treinnr", "rijdagenid", "locatie", "tijd"})}, indexes={@ORM\Index(name="idx_48835_tijd", columns={"tijd"}), @ORM\Index(name="idx_48835_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48835_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr7In
{
