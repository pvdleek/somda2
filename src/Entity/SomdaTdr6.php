 ...
 * SomdaTdr6
 *
 * @ORM\Table(name="somda_tdr_6", indexes={@ORM\Index(name="idx_48752_tijd", columns={"tijd"}), @ORM\Index(name="idx_48752_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48752_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr6
{
