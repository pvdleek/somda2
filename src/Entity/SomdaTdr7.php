 ...
 * SomdaTdr7
 *
 * @ORM\Table(name="somda_tdr_7", indexes={@ORM\Index(name="idx_48824_tijd", columns={"tijd"}), @ORM\Index(name="idx_48824_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48824_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr7
{
