 ...
 * SomdaTdr6In
 *
 * @ORM\Table(name="somda_tdr_6_in", uniqueConstraints={@ORM\UniqueConstraint(name="idx_48763_treinnr", columns={"treinnr", "rijdagenid", "locatie", "tijd"})}, indexes={@ORM\Index(name="idx_48763_tijd", columns={"tijd"}), @ORM\Index(name="idx_48763_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48763_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr6In
{
