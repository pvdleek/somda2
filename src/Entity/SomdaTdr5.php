 ...
 * SomdaTdr5
 *
 * @ORM\Table(name="somda_tdr_5", indexes={@ORM\Index(name="idx_48680_tijd", columns={"tijd"}), @ORM\Index(name="idx_48680_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48680_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr5
{
