 ...
 * SomdaTdr12In
 *
 * @ORM\Table(name="somda_tdr_12_in", uniqueConstraints={@ORM\UniqueConstraint(name="idx_48342_treinnr", columns={"treinnr", "rijdagenid", "locatie", "tijd"})}, indexes={@ORM\Index(name="idx_48342_tijd", columns={"tijd"}), @ORM\Index(name="idx_48342_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48342_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr12In
{
