 ...
 * SomdaTdr4In
 *
 * @ORM\Table(name="somda_tdr_4_in", uniqueConstraints={@ORM\UniqueConstraint(name="idx_48619_treinnr", columns={"treinnr", "rijdagenid", "locatie", "tijd"})}, indexes={@ORM\Index(name="idx_48619_tijd", columns={"tijd"}), @ORM\Index(name="idx_48619_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48619_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr4In
{
