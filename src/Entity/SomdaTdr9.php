 ...
 * SomdaTdr9
 *
 * @ORM\Table(name="somda_tdr_9", indexes={@ORM\Index(name="idx_48968_tijd", columns={"tijd"}), @ORM\Index(name="idx_48968_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48968_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr9
{
