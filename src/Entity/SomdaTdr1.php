 ...
 * SomdaTdr1
 *
 * @ORM\Table(name="somda_tdr_1", indexes={@ORM\Index(name="idx_48320_tijd", columns={"tijd"}), @ORM\Index(name="idx_48320_locatieid", columns={"locatieid"}), @ORM\Index(name="idx_48320_treinid", columns={"treinid"})})
 * @ORM\Entity
 */
class SomdaTdr1
{
